...
const TitleTemplate = ({ Data }: { Data: TitleTemplateData1['data'] }) => {
  return (
    <div className="flex flex-col border-b-2 dark:border-dark-dsmlcBlack border-light-dsmlcBlack border-opacity-25 pt-20 lg:w-full max-w-4xl w-fit m-auto pb-5 gap-3 mb-16">
