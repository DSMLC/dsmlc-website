...
export default function MemberEditorModal({
  ...
  return (
    ...
    >
      ...
      {/* Panel */}
      <div
        className={`relative w-full max-w-sm sm:max-w-2xl md:max-w-3xl lg:max-w-5xl xl:max-w-6xl mx-auto bg-light-dsmlcWhite dark:bg-dark-dsmlcWhite border border-light-dsmlcEnhancedParchment dark:border-dark-dsmlcEnhancedParchment rounded-xl sm:rounded-2xl
        transition-all duration-200 ease-out dark:text-dark-dsmlcBlack text-light-dsmlcBlack max-h-[95vh] overflow-hidden
        ...
        <div className="sticky top-0 z-10 flex items-center justify-between gap-2 sm:gap-4 px-3 sm:px-6 py-3 sm:py-4 border border-light-dsmlcEnhancedParchment dark:border-dark-dsmlcEnhancedParchment backdrop-blur">
          ...
          >
            ...
            {mode === "edit" && form.member_id != null ? (
              <span className="dark:text-dark-dsmlcBlack text-light-dsmlcBlack ml-1 sm:ml-2 text-xs sm:text-sm">
                • ID #{form.member_id}
              </span>
            ) : null}
          </h3>
